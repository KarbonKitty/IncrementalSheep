...
public static class Templates
{
    ...
    public static readonly Dictionary<SheepJobId, SheepJob> Jobs = new()
    {
        ...
        { SheepJobId.Elder, new(SheepJobId.Elder, "Elder", "An old and wise sheep, that can teach the tribe about wisdom of the ages. Perhaps this can help with learning something new?", new(ResourceId.Folklore, 0.66), new(ResourceId.Food, 100), new(ResourceId.Folklore, 100))}
    };
